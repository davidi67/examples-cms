...
testfiles = (
    "../binary-files/authEnvelopedForBobChaCha20Poly1305.p7m",
    "../binary-files/authEnvelopedForDanaX25519HKDF.p7m",
)


class AuthEnvelopedTestCase(unittest.TestCase):
    ...
    def do_testDerCodec(self, inputfile):
        ...
        #     asn1Spec=rfc5083.authEncryptedContentInfo())
        # self.assertFalse(rest)
