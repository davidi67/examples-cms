...
# Check all signed-data objects in `binary-files`
...
testfiles = (
    "../binary-files/signedByAliceRSA.p7m",
    "../binary-files/signedByAliceRSAPSS.p7m",
    "../binary-files/signedByCarlosEd25519.p7m",
    "../binary-files/signedByAliceAndCarlosNoCerts.p7m",
    "../binary-files/signedByCarlosDetached.p7m",
)
...
class SignedMessageTestCase(unittest.TestCase):
    ...
    def do_testDerCodec(self, inputfile):
        ...
        # Check we have signed-data type
